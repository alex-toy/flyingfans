...
foreach ($listeArticles as $art)
{
  echo 
  '<tr>
  		<td style="text-align:center"><p>', htmlspecialchars($art['depart']), '</p></td>
  		<td style="text-align:center">', htmlspecialchars($art['arrivee']), '</td>
  		<td style="text-align:center">le ', htmlspecialchars($art['dateAjout']->format('d/m/Y à H\hi')), '</td>
